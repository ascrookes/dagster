...
import {displayNameForAssetKey, __ASSET_GROUP_PREFIX} from '../asset-graph/Utils';
...
const InvocationList: React.FC<{
  ...
  const visible = invocations.filter((i) => !i.pipelineName?.startsWith(__ASSET_GROUP_PREFIX));
